...
var FileUpload = function () {
    ...
    var _componentFileUpload = function () {
        ...
        $('.file-input-ajax').fileinput({
            browseLabel: 'Browse',
            uploadUrl: base_url + "/GLOBAL/documents?type=" + fileType, // server upload action
            uploadAsync: true,
            maxFileCount: [maxFileCount],
            initialPreview: [document_name],
            overwriteInitial: true,
            initialPreviewAsData: true,
            allowedFileExtensions: allowed_extensions,// ["jpg", "gif", "png", "txt","doc","docx","xlsx","xlx"],
            browseIcon: '<i class="icon-file-plus mr-2"></i>',
            uploadIcon: '<i class="icon-file-upload2 mr-2"></i>',
            removeIcon: '<i class="icon-cross2 font-size-base mr-2"></i>',
            fileActionSettings: {
            ...
            $("#" + inputHiddenName).val(previewId.response.id);
